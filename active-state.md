...
| Aktiver Arbeitsauftrag | keiner – `SPK-004` ist menschlich abgenommen und `Done` |
| Nächste menschliche Aktion | Den Vorschlag für den nächsten zulässigen Paketkandidaten prüfen |
| Nächster Paketkandidat danach | `SPK-005` – Drag-and-drop-Verhalten prüfen |
