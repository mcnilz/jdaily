...
| FND-002 | P0 | Ready | .NET-, Paket- und Avalonia-Free-Versionen festsetzen | `global.json`, Central Package Management, .NET 10, Avalonia `11.3.18` und FuncUI/Elmish `1.6.0` sind exakt gepinnt; nur geprüfte Avalonia-Free-/OSS-Pakete, keine Preview-Pakete. | FND-001 |
...
| DOM-006 | P0 | Planned | Ereignisreihenfolge deterministisch machen | UTC, Quellreihenfolge, Scope-/Boardreihenfolge, Ereignisart und Event-ID liefern kultur- und eingabeunabhängig dieselbe Sequenz; `BoardOrdinal` steht vor dem Issue-Key-Fallback. | DOM-003, DOM-005 |
...
| DOM-008 | P0 | Planned | Repräsentative Jira-Fixtures aufbauen | Anonymisierte Fixtures decken Hierarchie, Multi-Sprint, Pagination, dynamischen/missing/equal Rank, Statusmapping und Fehler ab. | FND-003 |
