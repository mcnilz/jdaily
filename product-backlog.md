...
| SPK-002 | P0 | In Progress | Native-AOT-/Cross-Plattform-Spike | `Microsoft.Data.Sqlite 10.0.10` mit sicherem `SQLitePCLRaw.bundle_e_sqlite3 3.0.5`-Pin, explizitem JSON-Mapping und manueller Schema-Versionierung sind umgesetzt; Windows-AOT-Smoke, Notices und Lizenzgraph sind grün. Der Linux-Policy-Fehler ist als fehlender Git-LFS-Abruf für die acht inventarisierten Fontdateien behoben; der nächste erlaubte CI-Lauf liefert den Nachweis. | FND-008, DOM-008 |
