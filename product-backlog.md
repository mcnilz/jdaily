...
| UI-005 | P0 | Ready | Kernkomponenten im UiCatalog bauen | `SwimlaneHeader`, `TicketCard`, `CollapsedColumnCell` und `ReviewTrack` verwenden Produktionsviews und zeigen alle Pflichtzustände. | UI-003–004 |
