...
| SPK-001 | P0 | Ready | Avalonia-Composition- und BoardSurface-Spike | Drei Spalten, lane-lokale Bewegung, Abbruch, Reduced Motion und 1080p-/High-Resolution-Messwerte sind dokumentiert; endet mit ADR. Der durch `UI-007` erforderliche Headless-Harness ist nun menschlich abgenommen. | UI-003–005, UI-007 |
