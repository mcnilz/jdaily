...
| SPK-002 | P0 | In Progress | Native-AOT-/Cross-Plattform-Spike | `Microsoft.Data.Sqlite 10.0.10` mit sicherem `SQLitePCLRaw.bundle_e_sqlite3 3.0.5`-Pin, explizitem JSON-Mapping und manueller Schema-Versionierung sind umgesetzt; Windows-AOT-Smoke, Notices und Lizenzgraph sind grün. Die Eigentümerfreigabe vom 30. Juli 2026 erlaubt einen ausschließlich für Linux-/macOS-CI-Nachweise bestimmten Zwischencommit; danach folgt die menschliche Review. | FND-008, DOM-008 |
