...
| WFL-006 | P2 | Done | Vertical-Slice-Kontext-Routing vervollständigen | `eng/agent-context.ps1` klassifiziert `VS-*` als `VerticalSlice`, gibt die vereinigten Gates `G2`, `G3`, `G4`, `G5`, `G6` und `G8`, die zugehörigen DDD-, UI- und Handover-Abschnitte sowie das bestehende Profil `UI` aus. Der deterministische Fixture-Test deckt `VS-901` ab und schützt die bestehenden Domain-, UI-, Dependency-, Duplicate- und Unknown-Fehlerpfade. `VS-001` wird in `Propose` erfolgreich geroutet; `Docs`-Validierung ist grün. Menschlich abgenommen am 4. August 2026; Nachweis: [Agent Context Generator](eng/agent-context.ps1), [Fixture-Test](eng/tests/agent-context.Tests.ps1), [Agent Context Routing](docs/agent-context-routing.md). Nicht-Ziel: `VS-001`, `eng/validate.ps1`, Abhängigkeiten oder Readiness-Status ändern. | WFL-003 |
...
| DOM-007 | P1 | Done | Status-Bounce-Policy modellieren | `Aus` oder 1–30 Minuten, Standard 5, inklusive Grenze und Erhalt anderer Ereignisse sind pure getestet. Nachweis: 186/186 Unit- und Architekturtests sowie Release-Build ohne Fehler/Warnungen. Menschlich abgenommen am 8. August 2026. | DOM-005–006 |
...
| VS-003 | P0 | Done | Jira-Reihenfolge im Slice beweisen | Multi-Sprint, Pagination, gleicher/fehlender Rank und Filter verändern die erwartete relative Reihenfolge nicht. Nachweis: transportfreie `BoardProjection.projectSprintScope`, UiCatalog-Szenario `Board.JiraOrderProjection`, Release-Build und 197/197 Unit-/Headless-Tests. Menschlich abgenommen am 8. August 2026. | DOM-003–004, DOM-008, VS-002 |
| VS-004 | P0 | Done | Deterministisches Offline-Replay integrieren | Eine Swimlane und ein Subtask besitzen je einen Loop-Button; drei Statusereignisse und ein gefilterter Bounce laufen über steuerbare Keyframes. Menschlich abgenommen am 8. August 2026; Nachweis: Release-Build, 194/194 Unit- und 19/19 Headless-Visualtests. | DOM-005–007, SPK-001, VS-002 |
